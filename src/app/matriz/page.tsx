...
const TIMELINE: { fase: string; dono: string; cor: string; desc: string; icon: React.ElementType }[] = [
  ...
  { fase: "Captação / gravação", dono: "Guto", cor: GABRIEL, icon: Clapperboard, desc: "Grava o material bruto — orientação do Gabriel" },
  { fase: "Edição & design", dono: "Gabriel + Pet / Augusto", cor: GABRIEL, icon: Palette, desc: "Edita vídeos e cria as artes finais dos posts" },
  { fase: "Aprovação interna", dono: "Eliab / Gabriel", cor: "#f59e0b", icon: Circle, desc: "Revisa a entrega antes de mostrar ao cliente" },
  { fase: "Aprovação do cliente", dono: "Cliente", cor: "#34d399", icon: Circle, desc: "O cliente valida pelo portal e aprova ou pede ajuste" },
  { fase: "Publicação", dono: "Karyne", cor: ELIAB, icon: Send, desc: "Publica no perfil — orientação do Eliab" },
